        ...
        if (this.params.partialRender) {
            ...
            for(self.i = 0; self.i < this.backend.buffer.numberOfChannels; self.i++) {
                ...
                peaks.forEach(function(peak) {
                    ...
                    peak > 0.01 ? self._tempPeakIndexes[self.i].push(Array.prototype.indexOf.call(self._tempBuffer[self.i], peak)) : null
                });
            ...
            this._playAudioLikeBuffer = function() {
                ...
                this.blinkTestWindow = function(){
                    ...
                    self.e2blink = document.getElementById('test_blinker');
                    // fire color on true
                        ...
                        self.e2blink.style.backgroundColor = 'rgb('+self.r+','+self.g+','+self.b+')';
